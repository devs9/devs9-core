...
var InputPhoneMask = function (_a) {
    ...
    return useMemo(function () { return (React.createElement(MaskedInput, __assign({}, other, { showMask: true, type: "tel", id: "maskPhone", placeholderChar: "_", mask: masks.phone, ref: function (ref) { return inputRef(ref ? ref.inputElement : null); } }))); }, // eslint-disable-next-line react-hooks/exhaustive-deps
    [inputRef]);
};
var InputMask = memo(function (_a) {
    var inputProps = _a.inputProps;
    return (React.createElement(FormControl, null,
        React.createElement(InputMui, { inputProps: inputProps, inputComponent: InputPhoneMask })));
});

// export {IInput}
var Input = memo(function (_a) {
    var mask = _a.mask, inputProps = _a.inputProps;
    return (React.createElement(FormControl, null, !mask ? React.createElement(InputMui, { inputProps: inputProps }) : React.createElement(InputMask, null)));
});
